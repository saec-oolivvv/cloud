                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #111111; border-radius: 12px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 32px 24px;">
                            <h1 style="color: #ff4444; margin: 0 0 16px 0; font-size: 24px;">Échec du backup</h1>
                            <p style="color: #ffffff; margin: 0 0 24px 0;">Une erreur est survenue lors du backup automatique.</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 8px; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 16px;">
                                        ...
                                        <p style="margin: 0;"><strong style="color: #888888;">Erreur :</strong> <span style="color: #ff4444;"><?= htmlspecialchars($error_message) ?></span></p>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="color: #888888; font-size: 12px; margin: 0;">Veuillez vérifier la configuration de backup.</p>
                        </td>
                    </tr>
                    <tr>
