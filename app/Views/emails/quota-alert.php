                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #111111; border-radius: 12px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 32px 24px;">
                            <h1 style="color: #ff4444; margin: 0 0 16px 0; font-size: 24px;">⚠ Alerte quota</h1>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 8px; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 16px;">
                                        ...
                                        <p style="margin: 0 0 8px 0;"><strong style="color: #888888;">Type :</strong> <?= htmlspecialchars($type) ?></p>
                                        <p style="margin: 0;"><strong style="color: #ff4444;">Utilisation :</strong> <?= $percent ?>%</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 24px 0;">
                                <tr>
                                    <td style="background-color: #222; border-radius: 4px; height: 8px;">
                                        <div style="background-color: <?= $percent >= 90 ? '#ff4444' : '#ffaa00' ?>; width: <?= min($percent, 100) ?>%; height: 8px; border-radius: 4px;"></div>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="color: #888888; font-size: 12px; margin: 0;">Veuillez libérer de l'espace ou contacter l'administrateur.</p>
                        </td>
                    </tr>
                    <!-- Footer -->
                    <tr>
