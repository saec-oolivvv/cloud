    ...
    <div class="fb-content">
        ...
        <div class="fb-section" id="foldersSection">
            ...
            <div class="fb-grid" id="foldersGrid">
                ...
                <div class="fb-item fb-folder" data-id="<?= $folder['id'] ?>" data-type="folder" data-name="<?= htmlspecialchars($folder['name']) ?>" data-path="<?= htmlspecialchars($folder['path'] ?? '/') ?>" draggable="true" onclick="navigateToFolder(<?= $folder['id'] ?>)">
                    ...
                    <div class="fb-item-actions">
                        <button class="fb-action-btn" onclick="event.stopPropagation(); renameFolder(<?= $folder['id'] ?>, '<?= htmlspecialchars(addslashes($folder['name'])) ?>')" title="Renommer">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                        </button>
                        <button class="fb-action-btn fb-action-danger" onclick="event.stopPropagation(); deleteFolder(<?= $folder['id'] ?>)" title="Supprimer">
